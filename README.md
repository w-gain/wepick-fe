...
React SPA 기반과 `SCR-001`~`SCR-006`의 Mock 화면이 구현되어 있습니다. Express·바닐라 JavaScript MPA와 기존 게시판 화면은 제거했습니다. 현재는 확정 화면의 나머지 오버레이를 완성하고, 화면 모델 변환 계층을 통해 현재 BE를 연결하기 전 단계입니다.
